...
export default function Login() {
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center">
            ...
            <button className='text-white p-2.5 border-2 font-bold border-white rounded hover:bg-white hover:text-blue-900 transition absolute top-5 left-5'><a href="/">Voltar</a></button>
                    ...
                    <form className="space-y-6" onSubmit={handleLogin}>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="mt-1 block w-full bg-white/30 text-white placeholder-gray-300 border-none rounded-md px-3 py-2 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-900"
                            />
                        </div>
